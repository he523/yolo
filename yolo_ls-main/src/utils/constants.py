...
DEFAULT_WRONG_WAY_MIN_DISPLACEMENT_PX = 40.0
DEFAULT_WRONG_WAY_OPPOSING_STEP_RATIO = 0.65
...
# OCR
DEFAULT_OCR_INTERVAL = 15
DEFAULT_OCR_MAX_PER_FRAME = 8
DEFAULT_OCR_MIN_BBOX_HEIGHT = 50

# 风险
DEFAULT_RISK_INTERVAL = 2
DEFAULT_RISK_MAX_TRACKS = 20
