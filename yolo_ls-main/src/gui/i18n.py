...
_MESSAGES: Dict[str, Dict[str, str]] = {
    "zh_CN": {
        ...
        "status_processing": "分析中 · 点击「停止」结束",
        "status_stopped": "已停止",
...
""",
        ...
        "db_confirm_clean": "确定要清理 {days} 天之前的车辆、违规和流量记录吗？此操作不可恢复。",
        "sec_unit": "秒",
        "status_review": "待复核",
        "status_violation": "违规",
        "search_found": "找到 {n} 条匹配记录",
        "search_not_found": "未找到匹配记录",
        "clean_done": "已清理早于 {days} 天的历史记录。",
        "error_title": "错误",
    ...
    "en": {
        ...
        "db_clean_label": "Delete records older than (days):",
        "db_clean_btn": "Clean old records",
        ...
        "status_processing": "Processing · Click Stop to end",
...
""",
        ...
        "db_confirm_clean": "Delete vehicle, violation, and flow records older than {days} days? This cannot be undone.",
        "sec_unit": "s",
        "status_review": "Review",
        "status_violation": "Violation",
        "search_found": "Found {n} matching record(s)",
        "search_not_found": "No matching records found",
        "clean_done": "Removed records older than {days} days.",
        "error_title": "Error",
